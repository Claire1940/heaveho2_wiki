...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Heave Ho 2 Wiki",
    description: "Read the Terms of Service for Heave Ho 2 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Heave Ho 2 Wiki",
      description: "Terms and conditions for using Heave Ho 2 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Heave Ho 2 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Heave Ho 2 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Heave Ho 2 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Heave Ho 2 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Heave Ho 2". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and beginner tutorials</li>
              <li>Co-op and versus mode guides</li>
              <li>World and level walkthroughs</li>
              <li>Controls and platform setup guides</li>
              <li>Unlockable and achievement guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Heave Ho 2 Wiki is NOT affiliated with, endorsed by, or associated with
              Devolver Digital, Le Cartel Studio, Valve Corporation (Steam), or Nintendo. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Heave Ho 2 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Devolver Digital, Le Cartel Studio, Valve Corporation (Steam), and/or Nintendo. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, HEAVE HO 2 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Heave Ho 2 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@heaveho2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@heaveho2.wiki</a>
            </p>
            <p>
