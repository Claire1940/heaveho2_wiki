...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Heave Ho 2 Wiki',
    description: 'Heave Ho 2 Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Heave Ho 2 Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Steam, Nintendo, Discord, Reddit, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Heave Ho 2 Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Devolver Digital, Le Cartel Studio, Valve Corporation (Steam), or Nintendo. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@heaveho2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@heaveho2.wiki</a>
            </p>
            <p>
